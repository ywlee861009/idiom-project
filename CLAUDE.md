...
### 2. 버전 번호 업데이트 (`cmp/composeApp/build.gradle.kts`)
...
### 3. 서명된 AAB 빌드
keystore 정보는 `cmp/keystore/keystore-info.md` 에서 읽어온다.
...
### 4. AAB 이동 및 이름 변경
빌드 결과물(`cmp/composeApp/build/outputs/bundle/release/composeApp-release.aab`)을
