# 🗺️ Idiom Quiz Project Roadmap (v3.0)

## Phase 1 ~ 7: Foundation & Core UX (100% 완료)
- [x] **M1~M10**: 퀴즈 엔진 및 미니멀 UI 초기 버전 구현.
- [x] **M11. Ink-Spread**: 정답 시 먹물 효과 애니메이션 구현 (Lottie).
...
- [x] **M23. AdMob Integration**: 전면 광고(Interstitial) 및 보상형 광고(Rewarded) 수익화 구조 구축.
- [x] **M24. Firebase SDK**: Crashlytics 및 Analytics 연동 완료.
- [x] **M25. Reward System**: 콤보 시스템(연속 정답 보너스 XP, 최대 +5 캡) 및 서고 수집 로직 연동 완료. (2026-03-17)
